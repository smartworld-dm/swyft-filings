...
@section('content')
	<section class="hero dba">
		<div class="container container-dba p-0">
			<div class="text-area py-4 py-sm-5 pb-lg-4 col-lg-8 col-xl-7">
				<h1 class="text-white font-helvetica mb-3 mb-lg-4 pt-1 pt-lg-0 text-center text-lg-left font-weight-normal text-shadow-second">Form Your S Corporation <br> in as Few as 10 Minutes</h1>
	...
	<section class="process pt-5">
		<div class="container container-dba">
			<div class="headings text-center pb-6 mb-2">
				<h2 class="font-lato text-default font-weight-normal">Getting Started is Easy</h2>
	...
	<section class="business-section text-center">
		<div class="container">
			<h2 class="text-default font-weight-normal">Choose the Right Business Type</h2>
			...
			<div class="row">
				<div class="col-xl-4 col-12 mb-xl-0 mb-md-5 mb-0 text-left pl-md-0 pl-3">
					<div class="content">
						<h4 class="h4">Advantages of forming a C Corp</h4>
						<p>The most notable benefit provided to S Corps is their “pass through” taxation status, which can help owners reduce their overall tax liability. Also, S Corporations are unique in that they have the ability to distribute stock, but only to a limited number owners.</p>
					</div>
					...
					<ul class="corp-list">
						...
						<li>
							...
							<span>Limited Option to Sell Shares</span>
						</li>
					</ul>
	...
	<section class="begin border-bottom pt-6 pb-4">
		<div class="container container-dba">
			<div class="headings text-center pb-5">
				<h2 class="mb-3 text-default font-weight-normal">Are You Ready to Begin?</h2>
			...
			<div class="links text-center pb-5">
				<a class="text-white py-3 px-4 font-weight-bold" href="#!"> Start My S Corporation Today<i class="pl-1 ti-arrow-circle-right"></i></a>
			</div>
	...
	<section class="start-questions border-bottom pb-5 pt-5">
		<div class="container container-dba">
			<div class="headings text-center pb-4 mb-2">
				<h2 class="font-weight-normal pt-1 text-default">Common Questions About Starting an S Corporation</h2>
			...
			<div class="d-flex row justify-content-center ">
				<div class="col-xl-6 col-lg-12 border-right">
					<ul class="accordion mr-xl-5 mb-5">
						<li class="py-3 my-2">
							<a class="opener" href="#">What are the primary advantages of an S Corporation?</a>
							<div class="slide pt-4 mt-3">
								<p class="mb-0">The S Corporation structure is very similar to the C Corporation, with a few notable differences. The most important of these differences is that S Corporations are eligible for special pass through taxation status with the IRS. This allows S Corporation owners to avoid double taxation on their business income.</p>
							</div>
						</li>
						<li class="py-3 my-2">
							<a class="opener" href="#">Are there any restrictions on who can file to form an S Corporation?</a>
							<div class="slide pt-4 mt-3">
								<p class="mb-0">Outside of some state-specific regulations that require individuals to be 18 to own a business, there are no restrictions on who can form a corporation. However, if a corporation decides to elect for S Corporation status, there are several restrictions placed on who can become part of the organizations ownership. They are as follows:</p>
								<ul class="items-list ml-4">
									<li><span>All S Corporation shareholders must be legal citizens of the United States.</span></li>
									<li><span>S Corporations are only able to distribute one uniform class of stock.</span></li>
									<li><span>S Corporation are limited to 100 different shareholders</span></li>
									<li><span>Subsidiary organizations may not have an ownership interest in an S Corporation; all shareholders must be individuals.</span></li>
								</ul>
							</div>
						</li>
						<li class="py-3 my-2">
							<a class="opener" href="#">What are the tax implications of an S Corporation?</a>
							<div class="slide pt-4 mt-3">
								<p>One of the most common reasons that business owners elect to form an S Corporation is that the structure is eligible for pass-through taxation. Under this special tax status, the corporation is never taxed on its income. Instead, each individual owner is taxed on the company's profits and losses, as they are distributed and reflected on their personal income tax returns.</p>
							</div>
						</li>
						<li class="py-3 my-2">
							<a class="opener" href="#">Are there a required number of individuals needed to form an S Corporation?</a>
							<div class="slide pt-4 mt-3">
								<p>Most states only require one director in order to start an S Corporation. However, some states impose a minimum number of directors based on the number of shareholders the company has. This required number is typically never lower than three and there is no maximum limit.</p>
							</div>
						</li>
					</ul>
					<div class="links mr-xl-5 text-center pb-4">
						<a class="text-white py-2 px-4 font-lato font-weight-bold" href="#!"> View All S Corporation FAQs </a>
					</div>
				</div>
	...
	<section class="start-dba">
		<div class="container container-dba pt-5">
			<h2 class="pt-2 mb-5 text-center text-default">Ready to Incorporate Your Business?</h2>
			<div class="row">
